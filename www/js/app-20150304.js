...
angular.module('singlepage_app', ['ionic', 'starter.controllers', 'starter.services'], function($httpProvider) {
...
angular.module('tab_app', ['ionic', 'starter.controllers', 'starter.services'], function($httpProvider) {
  // Use x-www-form-urlencoded Content-Type
  $httpProvider.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded;charset=utf-8';
...
.run(function($ionicPlatform, $rootScope, User, Network) {
    ...
    //console.log("window.resolveLocalFileSystemURL=" + window.resolveLocalFileSystemURL);
    //window.resolveLocalFileSystemURL("cdvfile://localhost/persistent/token", function success(file) {
    //  file.createWriter(function(writer) {
    //    console.log("## writer=" + writer);
    //    var blob = new Blob(['abc'], {type:'text/plain'});
    //    writer.write(blob);
    //  }, function error() {
    //    console.log("## error create writer");
    //  })
    //});
  });
})
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab', {
    url: "/tab",
    abstract: true,
    templateUrl: "templates/tabs.v2.html"
  })
